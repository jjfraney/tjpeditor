package org.jjflyboy.tjpeditor.jvmmodel;
...
public class ProjectJvmModelInferrer extends AbstractModelInferrer {
  /**
   ...
   */
  protected void _infer(final Global element, final IAcceptor<JvmDeclaredType> acceptor, final boolean isPrelinkingPhase) {
  }
  ...
  public void infer(final EObject element, final IAcceptor<JvmDeclaredType> acceptor, final boolean isPrelinkingPhase) {
    if (element instanceof Global) {
      _infer((Global)element, acceptor, isPrelinkingPhase);
