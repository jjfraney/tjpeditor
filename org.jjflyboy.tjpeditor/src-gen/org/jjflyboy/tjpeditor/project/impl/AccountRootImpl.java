 ...
 * <ul>
 *   <li>{@link org.jjflyboy.tjpeditor.project.impl.AccountRootImpl#getAccount <em>Account</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AccountRootImpl extends ReportAttributeImpl implements AccountRoot
{
  ...
  {
    return ProjectPackage.eINSTANCE.getAccountRoot();
  }
    ...
    if (account != null && account.eIsProxy())
    {
      ...
      if (account != oldAccount)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProjectPackage.ACCOUNT_ROOT__ACCOUNT, oldAccount, account));
      }
    }
    return account;
  }
  ...
  public void setAccount(Account newAccount)
  {
    ...
    account = newAccount;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.ACCOUNT_ROOT__ACCOUNT, oldAccount, account));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProjectPackage.ACCOUNT_ROOT__ACCOUNT:
